...
def main():
    """Run the program to update galaxy.yml in case of a release."""
    # Define command line arguments
    parser = ArgumentParser(prog="Releasy.py - Generate galaxy.yml from template")
    parser.add_argument(
        "-t", "--template", required=False, default="galaxy.yml.j2", help="Relative path to galaxy template file"
    )
